...
function init() {
    ...
    $("#option-ud .left").click(function() {
        send("radar", {ud: true, offset: -0.2});
    });
    $("#option-ud .right").click(function() {
        send("radar", {ud: true, offset: 0.2});
    });

    $("#option-lr .left").click(function() {
        send("radar", {lr: true, offset: -1.0});
    });
    $("#option-lr .right").click(function() {
        send("radar", {lr: true, offset: 1.0});
    });

    $("#option-dist .left").click(function() {
        send("radar", {dist: true, offset: -1.0});
    });
    $("#option-dist .right").click(function() {
        send("radar", {dist: true, offset: 1.0});
    });
